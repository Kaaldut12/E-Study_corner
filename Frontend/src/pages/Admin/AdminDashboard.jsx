  ...
  return (
    <SidebarLayout>
      <div className="space-y-6">
        {/* Welcome Header */}
        <div className="glass-panel p-6 sm:p-8 rounded-2xl relative overflow-hidden border border-amber-500/20">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 relative z-10">
            <div>
              <span className="text-xs font-bold uppercase tracking-wider text-amber-400">Administrator Console</span>
              <h1 className="text-2xl sm:text-3xl font-extrabold text-white mt-1">
                System Command & Overview 🛡️
              </h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="glass-panel glass-panel-hover p-5 rounded-2xl border border-slate-800">
            ...
            <div className="text-xs text-indigo-400 mt-1 font-medium">
              {stats.studentCount || 0} Students · {stats.teacherCount || 0} Teachers
            </div>
          </div>

          <div className="glass-panel glass-panel-hover p-5 rounded-2xl border border-slate-800">
            <div className="text-slate-400 text-xs font-medium uppercase tracking-wider">Published Coursework</div>
            <div className="text-3xl font-extrabold text-indigo-400 mt-2">{stats.totalAssignments || 0}</div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="glass-panel p-6 rounded-2xl border border-slate-800 space-y-4">
            <div className="flex items-center justify-between border-b border-slate-800/80 pb-4">
              ...
              <Link to="/admin/users" className="text-xs text-indigo-400 hover:text-indigo-300 font-semibold">
          ...
          <div className="glass-panel p-6 rounded-2xl border border-slate-800 space-y-4">
            <div className="flex items-center justify-between border-b border-slate-800/80 pb-4">
              ...
              <Link to="/admin/messages" className="text-xs text-indigo-400 hover:text-indigo-300 font-semibold">
                View all tickets →
              </Link>
            </div>
