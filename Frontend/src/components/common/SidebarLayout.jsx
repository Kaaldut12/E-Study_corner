  ...
  const navSectionsByRole = {
    student: [
      ...
      },
      {
        ...
        items: [
          { path: '/student/notes', label: 'Notes', icon: 'M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z' },
      ...
      },
      {
        ...
        items: [
          ...
          { path: '/student/profile', label: 'Profile', icon: 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z' },
          { path: '/student/contact-admin', label: 'Support', icon: 'M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z' }
        ]
      }
    ],
    teacher: [
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col text-slate-100 font-sans">
      ...
      <div className="flex flex-1">
        ...
        {/* Sidebar */}
        <aside
          className={`fixed lg:sticky top-0 lg:top-16 left-0 z-40 w-60 h-screen lg:h-[calc(100vh-4rem)] bg-slate-900/95 border-r border-slate-800 transform transition-transform duration-200 ease-in-out flex flex-col pt-16 lg:pt-0 shrink-0 ${
