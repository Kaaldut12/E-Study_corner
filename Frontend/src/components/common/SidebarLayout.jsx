...
const SidebarLayout = ({ children }) => {
  ...
  const navItemsByRole = {
    ...
    teacher: [
      ...
      { path: '/teacher/create-assignment', label: 'Create Assignment', icon: 'M12 4v16m8-8H4' },
      { path: '/teacher/assignments', label: 'Manage Assignments', icon: 'M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10' }
    ],
    admin: [
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  `flex items-center gap-3 px-3.5 py-2.5 rounded-xl font-medium text-sm transition-all duration-200 ${
                    isActive
                      ? 'bg-linear-to-r from-indigo-600 to-purple-600 text-white shadow-lg shadow-indigo-600/25 font-semibold'
